...
--
-- Dumping routines for database 'keshe1'
--
/*!50003 DROP PROCEDURE IF EXISTS `pro_author` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pro_author`(IN authorid VARCHAR(255))
BEGIN
	SELECT submission.* 
